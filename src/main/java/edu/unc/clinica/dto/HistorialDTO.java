 ...
 * historial médico. Contiene información sobre el historial médico, incluyendo
 * su ID, fecha de registro, diagnósticos anteriores, tratamientos previos,
 * procedimientos realizados, medicamentos recetados, resultados de pruebas
 * médicas y el paciente asociado.
 */
@Data
