...
/**
 * La interfaz CitaService define operaciones para gestionar las citas en el sistema.
 * Proporciona métodos para listar citas, buscar cita por ID, grabar cita, actualizar cita, eliminar cita
 * y asignar una factura a una cita.
 */
