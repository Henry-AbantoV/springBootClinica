...
/**
 * Implementación de la interfaz EspecialidadService que define los servicios
...
public class EspecialidadServiceImp implements EspecialidadService {
	 ...
	 */
	@Override
	public Especialidad actualizarEspecilidad(Long id, Especialidad espec)
	...
	public void eliminarEspecialidad(Long IdEsp) throws EntityNotFoundException, IllegalOperationException {
		Especialidad especialidad = EspR.findById(IdEsp)
				.orElseThrow(() -> new EntityNotFoundException("La especialidad con id proporcionado no se elimino"));
	...
	@Override
	@Transactional
	public Especialidad asignarMedicos(Long IdEsp, Long IdMedico)
			throws EntityNotFoundException, IllegalOperationException {
		try {
			Especialidad EspeciEntity = EspR.findById(IdEsp)
					.orElseThrow(() -> new EntityNotFoundException("La especialidad con este id no existe en la BD"));
			Medico MedicEntity = medicoR.findById(IdMedico)
					.orElseThrow(() -> new EntityNotFoundException("El medico con este id no existe en la BD"));
