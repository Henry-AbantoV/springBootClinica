/*
 * @file CitaServiceImp.java;
 * @Autor Daniela Torres (c)2024
 * @Created 12 mar 2024,2:16:46
 */
...
/**
 * La clase CitaServiceImp implementa la interfaz CitaService y proporciona la
 * lógica de negocio para operaciones relacionadas con citas y facturas en el
 * sistema. Está marcada con la anotación @Service para indicar que es un
...
public class CitaServiceImp implements CitaService {
	...
	public void eliminarCita(Long IdCita) throws EntityNotFoundException, IllegalOperationException {
		Cita cita = citaR.findById(IdCita)
				.orElseThrow(() -> new EntityNotFoundException("La cita con id proporcionado no se encontro"));
