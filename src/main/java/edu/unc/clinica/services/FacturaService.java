...
/**
 * La interfaz FacturaService proporciona métodos para gestionar las operaciones
 * relacionadas con las facturas en el sistema. Define operaciones como listar
 * facturas, buscar factura por ID, grabar factura, actualizar factura y
 * eliminar factura.
 */
