...
public interface PacienteService {
	 ...
	 * @throws EntityNotFoundException Si no se encuentra el cliente con el ID
	 *                                 proporcionado.
	 */
	 ...
	 * @throws IllegalOperationException Si la reserva no fue realizada por el
	 *                                   cliente.
	 */
	 ...
	 * @throws EntityNotFoundException   Si no se encuentra el cliente, la reserva o
	 *                                   alguna habitacion asociada.
	 * @throws IllegalOperationException Si la reserva no pertenece al cliente o no
	 *                                   tiene habitaciones.
	 */
	List<Factura> obtenerFacturas(Long idPaciente, Long idCita)
	 ...
	 * @throws EntityNotFoundException   Si el paciente no se encuentra en la base
	 *                                   de datos.
	 * @throws IllegalOperationException Si se produce una operación ilegal durante
	 *                                   la obtención de las citas.
	 */
