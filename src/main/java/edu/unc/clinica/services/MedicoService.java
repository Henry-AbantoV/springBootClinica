...
/**
 * Esta interfaz define los métodos que debe implementar un servicio para gestionar la entidad Medico.
 */
public interface MedicoService {
     ...
     * @throws EntityNotFoundException Si no se encuentra ningún médico con el ID especificado.
     */
     ...
     * @throws EntityNotFoundException Si no se encuentra ningún médico o paciente con los IDs especificados.
     * @throws IllegalOperationException Si ocurre una operación ilegal durante la operación.
     */
